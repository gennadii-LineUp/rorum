 ...
 */
@Entity
@Table(name = "glossary_of_risks")
public class GlossaryOfRisks implements Serializable {
...
//    @JsonBackReference
    ...
    public GlossaryOfRisks name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GlossaryOfRisks completionDate(LocalDate completionDate) {
    ...
    public GlossaryOfRisks creationDate(LocalDate creationDate) {
    ...
    public GlossaryOfRisks importantTo(LocalDate importantTo) {
    ...
    public GlossaryOfRisks user(User user) {
        this.user = user;
        return this;
    }
    ...
    public GlossaryOfRisks glossaryOfPurposes(GlossaryOfPurposes glossaryOfPurposes) {
    ...
    public boolean equals(Object o) {
        ...
        GlossaryOfRisks glossaryOfRisks = (GlossaryOfRisks) o;
        return glossaryOfRisks.getId() != null && getId() != null &&
            Objects.equals(getId(), glossaryOfRisks.getId());
    }
