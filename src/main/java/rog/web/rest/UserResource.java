...
import rog.service.MailService;
import rog.service.UserService;
import rog.service.dto.UserDTO;
import rog.service.mapper.UserMapper;
import rog.web.rest.errors.BadRequestAlertException;
import rog.web.rest.errors.EmailAlreadyUsedException;
import rog.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody ManagedUserVM managedUserVM) throws URISyntaxException {
        ...
        } else if (userRepository.findOneByLogin(managedUserVM.getLogin()).isPresent()) {
...
////    }
    ...
    public ResponseEntity<UserDTO> getLocalAdminByUser() {
        log.debug("REST request to get local admin of current user.");
        User localAdmin = userService.getLocalAdminOfCurrentOrganisation();
        UserDTO userDTO = userMapper.userDTO(localAdmin);
