...
public class FilledRisksDTOValidatorUnitTest {

    @Autowired
    private Validator filledRisksDTOValidator;

    private FilledRisksDTO filledRisksDTO;
    ...
    @Before
    public void setup(){
        filledRisksDTO = new FilledRisksDTO();
        filledRisksDTO.setProbability(probabilityService.getMaxValue() + 1);
        filledRisksDTO.setPowerOfInfluence(-1);
    ...
    public void validateTest(){
        filledRisksDTOValidator.validate(filledRisksDTO);
